...
import {
  ...
  PRODUCT_TOP_REQUEST,
  PRODUCT_TOP_SUCCESS,
  PRODUCT_TOP_FAIL, CATEGORIES_LIST_FAIL, CATEGORIES_LIST_SUCCESS, CATEGORIES_LIST_REQUEST, SET_CATEGORY
} from '../constants/productConstants'
import { logout } from './userActions'

export const listProducts = (keyword = '', pageNumber = '', category= 'all') => async (
  dispatch
) => {
  try {
